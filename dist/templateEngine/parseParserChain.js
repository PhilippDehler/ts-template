...
function parseParserChain(input, type, schema) {
    ...
    for (let i = 0; i < input.length; i++) {
        ...
        operationChain.push((input) => operationChainItem.parser(input, args));
    }
    return operationChain;
}
exports.parseParserChain = parseParserChain;
